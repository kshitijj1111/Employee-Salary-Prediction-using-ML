...
try:
    ...
    st.error("Grok API key not found. Make sure you have created a .streamlit/secrets.toml file and added your XAI_API_KEY.")
...
# --- Grok Interpretation Function ---
def get_grok_interpretation(input_data, prediction):
    """
    Gets a human-readable interpretation of the prediction from Grok.
    """
    if not GROK_API_AVAILABLE:
        return "Grok API key not configured. Please add your key to the secrets file."
    ...
    **Instructions for your response:**
    ...
    try:
        response = client.chat.completions.create(
            model="grok-1", # Using a valid Grok model
...
After predicting, Grok AI will provide an interpretation of the result.
""")
...
if st.button("Predict Salary", type="primary"):
    ...
    # --- Display the Grok Interpretation ---
    st.subheader("💡 Grok's Interpretation")
    with st.spinner("Grok is thinking..."):
        interpretation = get_grok_interpretation(input_data, prediction)
